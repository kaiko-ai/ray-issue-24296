...
ray::_prepare_read() (pid=1296042, ip=192.168.1.40)
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/ray/data/read_api.py", line 902, in _prepare_read
    return ds.prepare_read(parallelism, **kwargs)
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/ray/data/datasource/file_based_datasource.py", line 326, in prepare_read
  ...
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/numpy/lib/shape_base.py", line 782, in array_split
...
Traceback (most recent call last):
  ...
  File "/tmp/ray-issue-24264/test/test_file_based_datasource.py", line 53, in <module>
    main()
  File "/tmp/ray-issue-24264/test/test_file_based_datasource.py", line 40, in main
    ds = ray.data.read_datasource(
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/ray/data/read_api.py", line 231, in read_datasource
    read_tasks = ray.get(
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/ray/_private/client_mode_hook.py", line 105, in wrapper
    return func(*args, **kwargs)
  File "/tmp/ray-issue-24264/.venv/lib/python3.9/site-packages/ray/worker.py", line 1809, in get
